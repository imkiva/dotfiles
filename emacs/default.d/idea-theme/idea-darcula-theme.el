(deftheme idea-darcula
  "Theme based on IntelliJ IDEA darcula theme")
...
(custom-theme-set-faces
 ...
 '(evil-search-highlight-persist-highlight-face ((t (:background 'DimGray))))
 '(show-paren-match-face ((t :background "DarkSlateGray")))
 )
